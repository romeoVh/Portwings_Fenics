...
# Problem definition
class RectangleProblem(ProblemBase):
    "2D wave test problem with known analytical solution."
    ...
    def exact_solution(self, time_str='t'):
        ...
        g = sym.cos(om_x * x + phi_x) * sym.sin(om_y * y + phi_y)
    ...
    def convert_sym_to_expr(self, t_i, p_ex, q_ex, degree=6, show_func=False):
        ...
        _q_ex = Expression((q_ex_1_code, q_ex_2_code), degree=degree, t=t_i)  # Vector valued expression

        return _p_ex, _q_ex

    def __str__(self):
        return "Rectangle Wave 2D"
